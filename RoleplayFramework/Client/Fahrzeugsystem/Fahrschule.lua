Fahrschule = {points = 0, falscheAntworten = 0,
	["Daten"] = {
		...
		{"Flugschein",1000},},
	["Fragen"] = {
		{"Was machst du, wenn sich dir ein Fahrzeug mit Blaulicht nähert?","Abbremsen","Die Musik aufdrehen","Rechts ran fahren und warten","Gegen einen Baum fahren",3},
		{"Wo darfst du parken?","Überall","Auf gekennzeichneten Parkplätzen","Auf Dächern","In fremden Garagen",2},
		{"Was darfst du am Steuer nicht?","Telefonieren","Lenken","Schlage hören","Das Fenster heruntermachen",1},},
	["Marker"] = {
